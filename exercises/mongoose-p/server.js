...
// Person.find({$or:[{hair:"grey"},{eyes:"green"}],weight:{"$lt":70}}).then((p)=>console.log(p))
//4. Find people who have at least 1 kid with grey hair

// Person.find({weight:{"$gt":100},"kids.wight":{"$gt":100}}).then((p)=>console.log(p))
